...
namespace ProiectMoldovanAlexWebAppMVC.Controllers
{
    public class BrandsController : Controller
    {
        ...
        public BrandsController(ProiectMoldovanAlexWebAppMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("BrandID,Name,Country,FoundedYear")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BrandID,Name,Country,FoundedYear")] Brand brand)
        {
            if (id != brand.BrandID)
            {
                return NotFound();
